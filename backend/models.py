...
class Kary(db.Model):
    ...
    data_ostatniego_naliczenia = db.Column(db.Date, nullable=False)
...
class Wypozyczenia(db.Model):
    ...
    termin_zwrotu = db.Column(db.Date, nullable=False)
    data_faktycznego_zwrotu = db.Column(db.Date, nullable=True)
...
class Rezerwacje(db.Model):
    ...
    termin_waznosci = db.Column(db.Date, nullable=False)
